    ...
    new_sub = """                    {/* SUBSCRIPTION TAB */}
                    {activeTab === 'subscription' && (
                        <div className="space-y-6 animate-in fade-in duration-700 pb-12 max-w-[1200px] mx-auto">
                            ...
                            {/* Nav Bar */}
                            <div className="flex gap-2 items-center text-sm font-bold pt-2 pb-6 border-b border-gray-50/50 overflow-x-auto custom-scrollbar">
                                <button className="px-4 py-2 text-gray-500 hover:text-gray-900 transition-colors whitespace-nowrap">Billing History</button>
                                <button className="px-4 py-2 text-gray-500 hover:text-gray-900 transition-colors whitespace-nowrap">Invoices</button>
                                <button className="px-4 py-2 text-gray-500 hover:text-gray-900 transition-colors whitespace-nowrap">Payment Methods</button>
                                <button className="px-4 py-2 text-[#D48D2A] relative flex justify-center whitespace-nowrap after:absolute after:bottom-[-24px] after:w-full after:h-0.5 after:bg-[#D48D2A]">Update Plan</button>
                                <div className="flex-1"></div>
                                <button className="px-4 py-2 text-red-500 hover:bg-red-50 rounded-lg flex items-center gap-2 transition-colors whitespace-nowrap"><FiX /> Cancel Subscription</button>
                            </div>
                            ...
                            <div className="bg-[#FFF8F0] border border-[#F2E8DB] rounded-[1.5rem] p-8 flex justify-between items-center mt-6">
                                ...
                                <button className="px-6 py-3 bg-white border border-gray-200 text-gray-900 rounded-xl font-bold text-xs shadow-sm hover:border-[#D48D2A] hover:text-[#D48D2A] transition-all flex items-center gap-2 shrink-0">Contact Enterprise Sales <FiArrowRight/></button>
                            </div>
