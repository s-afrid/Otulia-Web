    ...
    return (
        <div className="w-full bg-white pt-40 pb-16 montserrat">
            <SEO 
                ...
                description="Information about Otulia's global white-glove transport and delivery services for luxury assets."
            />
            <Navbar />
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-4xl canela font-bold text-gray-900 mb-8 text-center">Shipping & Delivery Information</h1>
                ...
                <div className="prose prose-lg max-w-none text-gray-600">
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">Global Logistics Partners</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">Vehicle Transport</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">Yacht Delivery</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">Insurance</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">Delivery Timelines</h2>
                    <p>
