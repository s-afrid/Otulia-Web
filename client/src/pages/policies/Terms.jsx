    ...
    return (
        <div className="w-full bg-white pt-40 pb-16 montserrat">
            <SEO 
                ...
                description="Read the Terms and Conditions of using Otulia's luxury asset marketplace."
            />
            <Navbar />
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-4xl canela font-bold text-gray-900 mb-8 text-center">Terms & Conditions</h1>

                <div className="prose prose-lg max-w-none text-gray-600">
                    <p className="mb-6">Last updated: January 26, 2026</p>

                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">1. Agreement to Terms</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">2. Luxury Asset Services</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">3. User Verification</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">4. Intellectual Property</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">5. Limitation of Liability</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">6. Contact Us</h2>
                    <p>
