    ...
    return (
        <div className="w-full bg-white pt-40 pb-16 montserrat">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-4xl canela font-bold text-gray-900 mb-8 text-center">Privacy Policy</h1>
                ...
                <div className="prose prose-lg max-w-none text-gray-600">
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">1. Information We Collect</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">2. How We Use Your Information</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">3. Data Security</h2>
                    <p>
                    ...
                    <h2 className="text-2xl canela font-semibold text-gray-900 mt-8 mb-4">4. Your Rights</h2>
                    <p>
