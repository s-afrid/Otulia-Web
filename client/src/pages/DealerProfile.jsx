...
const DealerProfile = () => {
        ...
        const fetchProfile = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    setError("This user does not have a public profile enabled. Public profiles are only available for Premium and Business members.");
                } else {
    ...
    return (
        <div className="min-h-screen bg-white">
            <SEO title={displayName} description={`Explore luxury assets from ${displayName} on Otulia.`} />
            <Navbar />
                        ...
                        <>
                            ...
                            <div className="mt-20">
                                <Pagination 
                                    ...
                                    onPageChange={(page) => {
                                        setCurrentPage(page);
                                        window.scrollTo({ top: document.querySelector('.pt-24').offsetTop - 100, behavior: 'smooth' });
                                    }} 
                                />
                            </div>
                        </>
