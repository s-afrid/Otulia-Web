...
const Estate_Search = () => {
  ...
  const handleSearch = (e) => {
    ...
    if (searchLocation.trim()) {
      ...
      navigate(`/category/estates?location=${searchLocation.trim()}&acquisition=${acquisition}`);
              ...
              {suggestions.map((suggestion, index) => (
                <li
                  ...
                  onMouseDown={(e) => { // Use onMouseDown to prevent onBlur from firing before onClick
                    ...
                    setQuery(suggestion);
                    setSuggestions([]);
                    navigate(`/category/estates?location=${suggestion}&acquisition=${activeType.toLowerCase()}`);
                  }}
                >
                  {suggestion}
                </li>
