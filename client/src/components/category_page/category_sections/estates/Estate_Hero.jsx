    ...
    <div>
      <div className='relative flex flex-col hero-banner h-[500px] md:h-[700px] w-full pt-24'>
        ...
        <div className='relative flex flex-col items-center justify-center h-full p-3 gap-3 z-10'>
          <h1 className='text-white canela text-3xl md:text-5xl text-center drop-shadow-lg'>Extraordinary Properties. Exceptional Living</h1>
          <p className='text-white/90 canela text-md md:text-2xl text-center drop-shadow-md'>Homes, villas, and estates across the world.</p>
