...
const Yacht_Search = () => {
  ...
  const handleSearch = (e) => {
    ...
    if (searchLocation.trim()) {
      ...
      navigate(`/category/yachts?location=${searchLocation.trim()}&acquisition=${acquisition}`);
              ...
              {suggestions.map((suggestion, index) => (
                <li
                  ...
                  onMouseDown={(e) => { // Use onMouseDown to prevent onBlur from firing before onClick
                    ...
                    setQuery(suggestion);
                    setSuggestions([]);
                    navigate(`/category/yachts?location=${suggestion}&acquisition=${activeType.toLowerCase()}`);
                  }}
                >
                  {suggestion}
                </li>
