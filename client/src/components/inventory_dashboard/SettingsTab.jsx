...
const SettingsTab = ({
  ...
  return (
    <div className="h-[calc(100vh-6rem-1rem)] flex flex-col gap-3 animate-in fade-in duration-700">
        ...
        <div className="flex-1 bg-white border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] rounded-[1.2rem] p-4 flex flex-col relative h-full">
          ...
          <div className="flex-1 overflow-auto custom-scrollbar pr-2 flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex border border-gray-200 rounded-lg bg-white overflow-hidden shadow-sm focus-within:border-[#D48D2A]">
                  <div className="flex items-center px-2 bg-gray-50 border-r border-gray-200 text-[10px] relative">
                    <select
                      ...
                      className="appearance-none bg-transparent outline-none pr-4 cursor-pointer font-bold"
                    >
                      {countryCodes.map((c) => (
              ...
              <div>
                ...
                <div className="relative w-full">
                  <div className="absolute inset-y-0 left-2.5 flex items-center pointer-events-none text-xs">
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  rows="3"
                  placeholder="I am a luxury asset consultant..."
                ></textarea>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="relative w-full">
                  <div className="absolute inset-y-0 left-2.5 flex items-center pointer-events-none text-[10px] font-serif font-black">
          ...
          <div className="pt-3 mt-auto shrink-0 border-t border-gray-50 flex">
            <button
              ...
              className="px-5 py-2 bg-gray-900 border border-transparent shadow-sm text-white rounded-[10px] text-[10px] font-bold hover:bg-gray-800 transition-colors flex items-center gap-2"
            >
              {isSavingPersonal && (
            ...
            <div className="relative h-20 bg-gray-50 rounded-xl overflow-hidden group shrink-0 shadow-sm border border-gray-100 mb-2">
              {companyInfo.coverImage ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center text-gray-300 gap-1">
                  <FiBriefcase className="text-xl opacity-30" />{" "}
              ...
              <div className="flex-1 flex flex-col gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCompanyInfo((p) => ({ ...p, website: e.target.value }))
                    }
                    className="w-full bg-white border border-gray-200 rounded-lg px-3 py-1.5 text-[10px] font-medium focus:border-[#D48D2A] outline-none shadow-sm"
                  />
                </div>
                ...
                <div className="flex items-center gap-2">
                  <div className="w-12 h-12 rounded-lg bg-gray-50 flex items-center justify-center border border-gray-200 shadow-sm overflow-hidden">
                    {companyInfo.logo ? (
                      ...
                      <FiBriefcase className="text-gray-300 text-lg" />
                    )}
                    {logoLoading && (
                      <div className="absolute inset-0 bg-white/80 flex items-center justify-center">
                        <div className="w-3 h-3 border-2 border-[#D48D2A] border-t-transparent rounded-full animate-spin"></div>
                      </div>
                    )}
                  </div>
                  <div className="flex flex-col justify-center">
      ...
      {/* 3 Bottom Cards */}
      <div className="grid grid-cols-3 gap-4 shrink-0 min-h-[140px]">
            ...
            {[
              ...
              >
                <span className="flex items-center gap-1.5 text-gray-600 font-medium">
                  <FiCheckCircle className="text-gray-400 text-[9px]" /> {v}
                </span>
        ...
        <div className="bg-white border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] rounded-[1.2rem] flex flex-col justify-between overflow-hidden">
          ...
          <div className="px-3 flex flex-col gap-1 bg-white flex-1 justify-center relative">
            <div className="flex justify-between items-center text-[9px] font-medium text-gray-600">
              <span className="flex items-center gap-1.5 text-gray-700 font-bold cursor-pointer hover:text-[#D48D2A]">
                <FiShield className="text-[10px] text-gray-400" /> Change
                Password
              </span>
            ...
            <div className="flex justify-between items-center text-[9px] font-medium text-gray-600">
              <span className="flex items-center gap-1.5 text-gray-700">
                <FiMonitor className="text-[10px] text-gray-400" /> Active
                Sessions
              </span>
