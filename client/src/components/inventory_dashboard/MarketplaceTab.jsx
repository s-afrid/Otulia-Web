      ...
      <div className="flex-1 flex gap-4 min-h-0">
        ...
        <div className="flex-[3] bg-white rounded-[1.5rem] p-5 border border-gray-100 shadow-[0_2px_15px_rgba(0,0,0,0.02)] flex flex-col min-h-0 relative">
          <div className="flex justify-between items-start mb-4 shrink-0">
            <div>
              <h3 className="inter text-[15px] font-semibold text-gray-900 mb-1 leading-none tracking-normal">
                Visibility Controls
              </h3>
              <p className="inter text-[10px] text-gray-400 font-medium border-l-[3px] border-[#D48D2A] pl-2 -ml-[3px]">
                ...
                >
                  ...
                  <div className="flex-1 flex justify-between items-center pr-2">
                    <div className="flex flex-col">
                      <h4 className="text-[14px] font-medium text-gray-900 canela leading-none mb-1.5">
                        {assetName}
                      </h4>
        ...
        <div className="flex-[2] bg-gray-900 rounded-[1.5rem] p-5 border border-gray-800 shadow-[0_4px_20px_rgba(0,0,0,0.2)] flex flex-col relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-6 shrink-0 relative z-10">
            <div>
              <h3 className="inter text-[15px] font-semibold text-white mb-1 leading-none tracking-normal">
                Live Marketplace Analytics
              </h3>
              <p className="inter text-[10px] text-gray-400 font-medium">
                Real-time performance on Otulia.com
              </p>
            </div>
          ...
          <div className="flex-1 flex gap-6 min-h-0 relative z-10">
            <div className="flex-1 flex flex-col justify-between">
              {[
                ...
                {
                  label: "Saves",
                  val: data?.stats?.trends?.saved?.current || 0,
                  icon: FiHeart,
                  col: "#D946EF",
                },
              ].map((s, idx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-gray-800 flex items-center justify-center text-gray-400 group-hover:bg-gray-700 group-hover:text-white transition-colors">
                      <s.icon className="text-sm" />
                    </div>
                    <span className="text-[14px] font-bold text-gray-400 inter">
                      {s.label}
                    </span>
                  </div>
                  <span className="text-[14px] font-bold text-white kaisei">
                    {s.val}
                  </span>
                </div>
              ))}
            ...
            <div className="flex-1 bg-gray-800/30 rounded-2xl border border-gray-700/30 p-4 flex flex-col justify-center items-center relative overflow-hidden">
              ...
              <div className="text-[32px] font-bold text-white mb-1 kaisei relative z-10">
                {((data?.stats?.totalLeads || 0) / 7).toFixed(1)}
              </div>
              <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest relative z-10">
                Inquiries / Week
              </span>
