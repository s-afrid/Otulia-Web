  ...
  return (
    <>
      ...
      <section className="w-full bg-white py-0 px-6 md:px-10 lg:px-12 mt-4">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-10 items-center pt-8">
          {/* LEFT CONTENT */}
      ...
      <section className="w-full bg-white py-2 px-6 md:px-10 lg:px-16">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-30 items-center pt-8">
          {/* LEFT CONTENT */}
          <div className="w-full flex justify-center lg:justify-end">
      ...
      {/* ONE SUBSCRIPTION SECTION */}
      <section className="w-full bg-white py-2 px-6 md:px-10 lg:px-16">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center pt-8">
          {/* LEFT CONTENT */}
          <div className="max-w-xl">
            <h2
              className="text-black text-[40px] md:text-[65px] leading-[1.05] font-light"
