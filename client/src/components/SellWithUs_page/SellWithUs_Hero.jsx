...
import heroUrl from '../../assets/hero_banners/sell_with_us.webp';
...
const SellWithUs_Hero = () => {
  return (
    <div className="relative flex flex-col bg-white h-screen w-full z-20 overflow-hidden">
      ...
      <div className="relative h-full w-full flex flex-col justify-center px-[6%] md:px-[3%] z-10 pt-20">
        <div className="max-w-4xl">
          {/* Top Label - Precise matching of the reference image */}
          <div className="flex items-center gap-4 mb-8">
            <div className="w-10 h-[1px] bg-[#C8922A]"></div>
          ...
          <div className="leading-[1.1] md:leading-[1]">
            ...
            <h1 className="text-[#C8922A] italic font-light text-[44px] sm:text-[58px] md:text-[72px] lg:text-[80px] tracking-tight canela">
              for Luxury Assets.
            </h1>
          </div>
          ...
          <p className="mt-8 max-w-2xl text-white/90 text-sm md:text-lg leading-relaxed font-light montserrat">
            Luxury marketplace infrastructure designed for dealerships, real 
            estate agencies, yacht brokers and elite asset sellers.
          </p>

          {/* Button - Exact match of the style */}
