...
import Trending_Hero from "./Trending_Hero";
...
const Trending_Section = ({ type }) => {
  const brands = [
    ...
    },
    {
      id: 4,
      image:
        "https://w7.pngwing.com/pngs/259/599/png-transparent-lamborghini-logo-lamborghini-sports-car-audi-logo-lamborghini-emblem-car-gold-thumbnail.png",
    },
    {
      id: 5,
      image:
        "https://w7.pngwing.com/pngs/204/34/png-transparent-mitsubishi-motors-car-logo-mitsubishi-eclipse-cross-mitsubishi-angle-text-triangle-thumbnail.png",
    },
  ];
      ...
      <section className="w-full px-3 md:px-6 py-6 bg-white">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {listings.map((item, idx) => (
            <AssetCard key={item.id} item={item} idx={idx} />
          ))}
        </div>
      </section>
    </div>
