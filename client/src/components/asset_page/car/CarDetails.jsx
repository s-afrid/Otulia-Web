...
*Kindly do not edit this message to ensure your inquiry is sent to the agent.`;
  ...
  return (
    <>
      ...
      />
      <div className="w-full px-[2%] py-4 md:py-8 bg-white font-sans">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
          ...
          <div className="w-full lg:w-[60%]">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-y-3 gap-x-4 text-xs text-gray-600 montserrat">
                {Object.entries(
                  item.specification || item.keySpecifications || {},
                )
                  .slice(0, 8)
                  .map(([key, val]) => {
          ...
          <div className="w-full lg:w-[35%] flex flex-col gap-6">
            <div className="w-full flex flex-col pt-1">
              <span className="text-[10px] font-bold text-[#B58252] uppercase tracking-widest mb-1 w-fit">
                PRICE
              </span>
              <h2
              ...
              <div className="flex gap-4 justify-between items-center text-center pb-4 border-b border-gray-100">
                <div className="flex flex-col items-center gap-1.5 flex-1">
                  ...
                  <span className="text-[9px] font-bold text-gray-500 uppercase tracking-widest">
                    {location ? location.split(",").pop().trim() : "Location"}
                  </span>
                </div>
                ...
                <div className="flex flex-col items-center gap-1.5 flex-1">
                  ...
                  <span className="text-[9px] font-bold text-gray-500 uppercase tracking-widest text-center">
                    Top Seller
                    <br />
                    Rank
                  </span>
            ...
            <div className="mt-2">
              ...
              <div className="grid grid-cols-2 gap-3 pb-8">
                ...
                <button
                  ...
                  className="bg-[#16a34a] text-white p-3 rounded-xl flex items-center justify-start gap-3 hover:bg-[#15803d] transition-all shadow-sm"
                >
                  <FaWhatsapp className="w-6 h-6 opacity-90 shrink-0 ml-1" />
                  <div className="flex flex-col items-start leading-tight">
                    <span className="font-bold text-sm">WhatsApp</span>
                    <span className="text-[9px] text-green-100 font-medium">
                      Chat on WhatsApp
                    </span>
                  </div>
                </button>
                <button
                  ...
                  className="border border-gray-200 bg-white text-black p-3 rounded-xl flex items-center justify-start gap-3 hover:bg-gray-50 transition-all shadow-[0_2px_10px_rgba(0,0,0,0.02)]"
                >
