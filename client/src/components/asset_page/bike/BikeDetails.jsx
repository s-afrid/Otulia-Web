...
const BikeDetails = ({ item, modelName = 'CarAsset' }) => {
        ...
        <div className="w-full lg:w-2/3">
          ...
          {item.listingReference && (
            <div className="flex items-center gap-2 mb-4">
              <span className="text-xs font-bold uppercase tracking-widest text-gray-400">Listing Reference ID</span>
              <div className="flex items-center gap-1.5 px-2 py-1 bg-gray-50 border border-gray-100 rounded-md">
                <span className="text-xs font-bold font-mono text-gray-700">{item.listingReference}</span>
                <button 
                  onClick={() => {
            ...
            <div className="flex items-center justify-between montserrat">
              <div className="flex-1 min-w-0 mr-4">
                ...
                <p className="text-[10px] text-gray-400 uppercase tracking-widest">
                  {type === 'Rent' ? 'Rental Fleet' : 'Exclusive Collection'}
                </p>
              </div>
              {agent.companyLogo && (
                <img
