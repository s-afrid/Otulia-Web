          ...
          <div className="w-full lg:w-[35%] flex flex-col gap-6">
            <div className="w-full flex flex-col pt-1">
              <div className="flex items-center justify-between gap-4 mb-2">
                <span className="text-[10px] font-bold text-[#B58252] uppercase tracking-widest block">
                  PRICE
                </span>
              ...
              {isPriceOnDemand ? (
                ...
                <div>
                  ...
                  <div
                    className="text-lg md:text-xl text-gray-400 line-through font-normal mb-0.5"
                    style={{
                      fontFamily: 'Canela, "Times New Roman", Times, serif',
                    }}
                  >
                  ...
                  <div className="flex items-center gap-3 flex-nowrap">
                    ...
                    <div className="bg-[#dcfce7] border border-[#bbf7d0] text-[#166534] px-2.5 py-1 rounded-full text-xs font-bold inline-flex items-center gap-1.5 shrink-0 whitespace-nowrap">
                      <FiTag className="w-3.5 h-3.5 rotate-90 shrink-0" />
              ...
              {!isPriceOnDemand && (
                <div className="text-xs text-gray-500 font-normal mt-2.5 flex items-center gap-1.5">
                  ...
                  <span>
                    This price is available when you purchase through{" "}
                    <strong className="font-semibold text-gray-700">Otulia</strong>.
                  </span>
                </div>
              )}
            </div>
