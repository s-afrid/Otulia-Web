...
import { FiPhoneCall, FiShoppingCart, FiHeart, FiMapPin, FiCalendar, FiChevronRight } from "react-icons/fi";
      ...
      <div className="w-full px-[2%] py-10 bg-white font-sans">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
          ...
          <div className="w-full lg:w-[35%] flex flex-col gap-6">
            ...
            {/* RENTAL BOOKING BOX */}
            {type === "Rent" && (
              <div className="border border-gray-200 rounded-xl shadow-sm p-5 bg-white">
