        ...
        const formattedCategories = categories.map(c => {
            const nominees = c.targetType === 'Assets' 
                ? (c.assetNominees || []).map(n => ({
                    ...
                    twitter: n.twitter || '',
                    tiktok: n.tiktok || '',
                    youtubeFollowers: n.youtubeFollowers || n.keyDetails?.youtubeFollowers || '',
                    instagramFollowers: n.instagramFollowers || n.keyDetails?.instagramFollowers || '',
                    twitterFollowers: n.twitterFollowers || n.keyDetails?.twitterFollowers || '',
                    tiktokFollowers: n.tiktokFollowers || n.keyDetails?.tiktokFollowers || '',
                    totalFollowers: n.totalFollowers || n.keyDetails?.totalFollowers || '',
                    votes: n.votes || 0,
        ...
        if (nominees && nominees.length > 0) {
            for (const nom of nominees) {
                const newNominee = new Model({
                    ...
                    twitter: nom.twitter || '',
                    tiktok: nom.tiktok || '',
                    youtubeFollowers: nom.youtubeFollowers || nom.keyDetails?.youtubeFollowers || '',
                    instagramFollowers: nom.instagramFollowers || nom.keyDetails?.instagramFollowers || '',
                    twitterFollowers: nom.twitterFollowers || nom.keyDetails?.twitterFollowers || '',
                    tiktokFollowers: nom.tiktokFollowers || nom.keyDetails?.tiktokFollowers || '',
                    totalFollowers: nom.totalFollowers || nom.keyDetails?.totalFollowers || nom.keyDetails?.subscribers || '',
                    ...(nom.asset ? {
                        asset: nom.asset,
        ...
        if (nominees && nominees.length > 0) {
            for (const nom of nominees) {
                ...
                const newNominee = new Model({
                    ...
                    youtubeFollowers: nom.youtubeFollowers !== undefined ? nom.youtubeFollowers : (nom.keyDetails?.youtubeFollowers || (match ? match.youtubeFollowers : '')) || '',
                    instagramFollowers: nom.instagramFollowers !== undefined ? nom.instagramFollowers : (nom.keyDetails?.instagramFollowers || (match ? match.instagramFollowers : '')) || '',
                    twitterFollowers: nom.twitterFollowers !== undefined ? nom.twitterFollowers : (nom.keyDetails?.twitterFollowers || (match ? match.twitterFollowers : '')) || '',
                    tiktokFollowers: nom.tiktokFollowers !== undefined ? nom.tiktokFollowers : (nom.keyDetails?.tiktokFollowers || (match ? match.tiktokFollowers : '')) || '',
                    totalFollowers: nom.totalFollowers !== undefined ? nom.totalFollowers : (nom.keyDetails?.totalFollowers || nom.keyDetails?.subscribers || (match ? match.totalFollowers : '')) || '',
                    ...(nom.asset ? {
                        asset: nom.asset,
                        ...(nom.assetModel ? { assetModel: nom.assetModel } : {})
                    } : {}),
